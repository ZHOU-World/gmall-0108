...
public class OssController {
    ...
    public ResponseVo policy(){
        String accessId = "LTAI5t9ZCiirreZ1jVTPjxM7"; // 请填写您的AccessKeyId。
        String accessKey = "lmJZ9BiF45NCT6PvnqI1ZFZ59b4Wdu"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "210108sh"; // 请填写您的 bucketname 。
